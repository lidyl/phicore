...
# -*- coding: utf-8 -*-
#
# phicore documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'phicore.tex', 'phicore Documentation',
     'LIDYL CEA', 'manual'),
]
